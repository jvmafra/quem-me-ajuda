...
public class TutorRestController {
	...
	@RequestMapping(value = "/aluno/tutor", method=RequestMethod.GET, params="matricula")
    public Aluno getTutorByMatricula(String matricula){
        return alunoService.getTutorByMatricula(matricula);
    }
	
	@RequestMapping(value="/aluno/tutor", method=RequestMethod.GET)
    public Iterable<Aluno> getAlunos(){
        return alunoService.getAllTutores();
    }
	
	@RequestMapping(value="/aluno/tutor", method=RequestMethod.POST)
    public Aluno save(@RequestBody Tutoria tutoria){
